...
class RegistrantFacadeTest {
    ...
    void test1() {
        RegistrantWriteModel registrant = new RegistrantWriteModel("adam@gmail.com", "password");
        Registrant createRegistrant = facade.simpleRegistration(registrant);
        inMemo.save(createRegistrant);
    }
}
